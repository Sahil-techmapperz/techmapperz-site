...
const PhotogrammetryServices = () => {
    return (
        <div className="bg-gray-900 text-white">
            ...
            <section className="w-full bg-black py-8 px-[50px]">
                <div className="flex flex-col w-full mb-8">
                    <p className="text-[18px] leading-7 text-center mb-6">
                ...
                <div className="py-8">
                    <div className="flex flex-col sm:flex-row gap-12">
                        <Image src={Photogrammetry1} alt="Aerial Triangulation and Ortho Photo Generation" className="w-[40%] object-contain" />
                        ...
                        <h1 className="text-3xl font-semibold mb-4">Aerial Triangulation & Ortho Photo generation</h1>
                            ...
                            <button
                                    className='py-[10px] mt-[100px] px-[15px] w-fit rounded-sm'
                                    style={{
                ...
                <div className="w-full py-8 bg-cover bg-center" >
                    <div className="flex flex-col sm:flex-row gap-12">
                        ...
                        <Image src={Photogrammetry2} alt="Digital Terrain Model and 3D Visualization" className="w-[60%] mt-[-120px] sm:w-1/2 object-contain" />
                    </div>
                </div>
