...
const DroneService = () => {
    return (
        <div className="bg-black overflow-hidden text-white">
            ...
            <section className="w-full py-8 px-[50px]  bg-black relative overflow-hidden">
                <div className="flex flex-col">
                    ...
                    <p className="text-[18px] text-center font-normal leading-7 tracking-wide text-gray-300">
                ...
                <div className="py-8 relative">
                    <div className="grid grid-cols-1 items-center md:grid-cols-2 gap-10">
                        <div className="flex flex-col justify-center items-center mt-[2rem]">
                            <Image src={Drone_Service1} alt="Geospatial Mapping" className="w-[80%] object-contain mb-4" />
                        ...
                        <div className="relative">
                            <div className="flex flex-col gap-4">
                                ...
                                <ul className='text-[18px] font-semibold list-disc ml-5'>
                    ...
                    <div className="py-8">
                        <div className="flex flex-col md:flex-row justify-center items-center gap-20">
                            <div className="relative md:w-1/2">
                                ...
                                <p className="text-[18px] leading-7 text-justify mb-4">
                            ...
                            <div className="md:w-1/2">
                                <Image src={Drone_Service2} alt="2D/3D Feature Extraction" className="w-[80%] object-contain mt-4 md:mt-0" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="py-8 bg-cover bg-center relative" >
                        <div className="flex flex-col md:flex-row justify-center items-center gap-20">
                            <div className="md:w-1/2">
                                <Image src={Drone_Service3} alt="3D Modelling" className="w-[80%] object-contain md:mt-0" />
                            </div>
