                    ...
                    <div className="grid gap-8">
                        <div className="flex flex-col justify-center items-center md:flex-row gap-2">
                            <div className="md:w-1/2 ">
                                <Image src={WebGis1} alt="" className="w-[60%] mx-auto mb-4" />
                            </div>
                            <div className="md:w-1/2 relative">
                                <h1 className="text-[25px] font-semibold mb-4">Geospatial programming & Web Map Development</h1>
                                ...
                                <ul className="list-disc ml-5 text-[18px] font-semibold mb-8 text-blue-500">
                        ...
                        <div className="flex justify-center pl-[120px] items-center gap-4 w-full" >
                            <div className="md:w-1/2">
                                <p className="mb-8 text-[18px]">
                                    Geographic Information System (GIS) has the potential to go beyond mapping. GIS offers a diverse set of analytical functions.
                                </p>
                            ...
                            <div className="md:w-1/2">
                                <Image src={WebGis2} alt="" className="w-[60%] h-auto mb-4" />
                            </div>
                        </div>
                    </div>
                </div>
