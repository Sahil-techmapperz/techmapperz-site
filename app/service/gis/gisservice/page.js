      ...
      <section className="p-8 lg:p-20 lg:px-[150px]">
        <div className="mb-16">
          {/* <p className="text-center text-white text-[18px]">
            GIS (Geographical Information System) is a process that stores, creates, manages, analyses, and displays different types of <br />
            spatial data. Geospatial services describe objects, events or other features with a location on or near the surface of the <br />
            earth typically combining coordinates on the earth and the characteristics of the object, event or The location <br />
            information provided may be static in the short or dynamic (for example, a moving vehicle or pedestrian, <br />
            the spread of an infectious disease). Techmapperz offers GIS services with an end-to-end solution <br />
            for spatial data storing, management and analysis to Government and Enterprise sectors <br />
            through GIS services. Techmapperz uses new-edge technology, deep research and <br />
            innovation that are implemented by high skilled and experienced GIS analysts <br />
            to create a simple solutions for a complex problems. The various GIS-<br />
            Data services offered by Techmapperz are:<br />
          </p> */}
        ...
        <div className="mb-16">
          <div className="flex flex-col justify-center items-center lg:flex-row gap-[50px]">
            ...
            <div className="flex flex-col gap-4 justify-center">
              <h2 className="text-[24px] font-bold">Geospatial Mapping</h2>
              ...
              <ul className="list-disc list-inside text-[18px] flex flex-col gap-4">
