...
import home_about_us_banner from '@/public/Photos/home_about_us_banner.png';
...
const AboutUs = () => {
  return (
    <section className="relative py-[70px] px-[4rem] flex flex-col justify-center items-center overflow-hidden bg-cover bg-center parallax">
      ...
      <div className="z-[2] flex flex-col gap-[6rem] md:flex-row justify-between items-center w-full max-w-7xl mx-auto">
        <div className="w-full md:w-1/2 flex flex-col items-center relative">
          <Image src={home_about_us_banner} alt="" className="mb-8" />
        </div>
        <div className="w-full md:w-1/2 text-center md:text-left">
          <Image src={Home_9} alt="" className="absolute top-4 right-4 w-24" />
