    ...
    <div className="bg-black text-white">
      ...
      <div className="p-20 bg-black">
        <div className='flex flex-col gap-4 justify-center'>
          <p className='text-[30px] font-[600] text-center'>Your concerns are our priority, we are just a click away</p>
          <p className='text-[#396BA9] font-[600] text-[25px] text-center'>We'd love to hear from you</p>
          <p className='text-center'>It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using
            Lorem Ipsum is that it has a more-or-less normal distribution of letters, </p>
        </div>
        <div className='flex gap-[30px] mt-[50px]'>
          <div className="lg:w-1/2">
            <Image src={contact_img1} className='w-full' />
          </div>
          <div className="lg:w-1/2">
            <ContactForm />
          </div>
        ...
        <div className='flex gap-[30px] mt-[50px]'>
          <div className='w-[70%] flex flex-col gap-[20px] justify-center border-r'>
            ...
            <button className='py-[10px] px-[15px] w-fit rounded-sm' style={{ background: "linear-gradient(90deg, #EC212C 0%, #396BA9 100%)" }}>Request a Demo</button>
          </div>
          <div>
      ...
      <div className='flex justify-between bg-[#396BA9] text-white h-[250px] mt-[50px] py-[20px] px-[50px]'>
        <div className='flex flex-col gap-4 justify-between'>
          <p className='text-[30px] font-[600]'>Let’s Talk</p>
          <p>Tell us about your next project.</p>
          <p className='border-b-2 border-[#87171D] w-fit text-black font-[500]'>Info@techmapperz.com</p>
        </div>
        <div className='flex flex-col gap-4 justify-between'>
          <p className='text-[30px] font-[600]'>Say Hello</p>
          <p>Drop us a line or give us a call.</p>
          <p className='border-b-2 border-[#87171D] text-black w-fit font-[500]'>www.techmapperz.com</p>
        </div>
        <div className='flex flex-col justify-between'>
          <p className='text-[30px] font-[600]'>Our Offices</p>
          <div>
            <p>55, Lane - 2, Westend Marg, Saidullajab, <br /> Near Saket metro station, New Delhi - 110030, India</p>
            <p>CF 401, Block CF, Sector 1, Salt Lake, Kolkata-700064,
              India</p>
          </div>
