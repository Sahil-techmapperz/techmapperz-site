...
const Career = async () => {
  ...
  return (
    <div className="bg-black text-white">
      ...
      <div className="flex  justify-between px-[50px] py-4 items-center">
        <div className="flex flex-col justify-center gap-4">
          <h1 className="text-[45px]">Do what you love <br/> Love what you do</h1>
          <p>Come Build the Future with  <span className="text-[#396BA9] font-bold"> Techmapperz </span></p>
      ...
      <div className="bg-[#ECF1FD] w-full flex justify-between text-black py-[20px] px-[50px]">
        <div className="flex flex-col justify-center gap-4">
          <h1 className="text-[45px] font-[600]">Have a Question ?</h1>
          <p className="font-[600]">For Job Inquiry : - <span className="text-[#E81515]"> info@tchmapperz.com </span></p>
        ...
        <div>
          <Image src={career_question_img} alt="career_question_img" />
        </div>
