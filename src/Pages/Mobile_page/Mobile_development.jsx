    ...
    return (
        <div className={styles.Mobile_development}>
            <section className={styles.first_part}>
                ...
                <p>Home / Services / IT Services /Mobile Application Development</p>
            </section>
            ...
            <section className={styles.secand_part}>
                ...
                <div className={`${styles.contaner} ${styles.contaner_card2} `}>
                    ...
                    <div className={styles.product}>
                        ...
                        <img src={Development6} alt="Development6.png" />
                        </div>
                ...
                <div className={styles.contaner}>
                    ...
                    <div className={styles.main}>
                        ...
                        <div className={styles.card}>
                            <img src={Combind3} alt='Combind3.png' />
                            <h3>Web-based App</h3>
